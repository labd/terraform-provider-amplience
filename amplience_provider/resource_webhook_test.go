...
func TestAccWebhooks_createAndReCreate(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.0.secret", "false"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.1.key", "X-second-Header"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.1.value", "321cba"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.1.secret", "true"),
					resource.TestCheckResourceAttr(
			...
			{
				Config: testAccWebhookRecreate(webhookLabel),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "label", webhookLabel),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "secret", "a-different-test-secret"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "notifications.#", "1"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "notifications.0.email", "example.person@examplemail.com"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.#", "1"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.0.key", "X-Additional-Header"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.0.value", "abc12345"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "header.0.secret", "false"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "filter.#", "2"),
					...
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "filter.1.arguments.0.value.1", "123"),
					resource.TestCheckResourceAttr(
						"amplience_webhook.standard", "filter.1.arguments.0.value.2", "a third value"),
					resource.TestCheckResourceAttr(
...
func testAccWebhookRecreate(label string) string {
	return fmt.Sprintf(`
    resource "amplience_webhook" "standard" {
      label = "%[1]s"
      ...
      notifications {
		email = "example.person@examplemail.com"
	  }

      secret = "a-different-test-secret"
...
// testAccWebhookUpdate keeps headers and notifications the same as testAccWebhooksConfig and should therefore not force
// a new resource to be created but update as "normal"
